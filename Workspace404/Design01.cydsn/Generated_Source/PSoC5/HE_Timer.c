...
uint8 HE_Timer_initVar = 0u;


/*******************************************************************************
* Function Name: HE_Timer_Init
********************************************************************************
*
* Summary:
...
void HE_Timer_Init(void) 
{
    ...
    HE_Timer_WritePeriod(HE_Timer_INIT_PERIOD);
    HE_Timer_WriteCounter(HE_Timer_INIT_PERIOD);

    #if (HE_Timer_UsingHWCaptureCounter)/* Capture counter is enabled */
        ...
        HE_Timer_interruptState = CyEnterCriticalSection();

        /* Use the interrupt output of the status register for IRQ output */
        HE_Timer_STATUS_AUX_CTRL |= HE_Timer_STATUS_ACTL_INT_EN_MASK;

        /* Exit Critical Region*/
        CyExitCriticalSection(HE_Timer_interruptState);
        ...
        #if (HE_Timer_InterruptOnCaptureCount && !HE_Timer_UDB_CONTROL_REG_REMOVED)
    ...
    HE_Timer_SetInterruptMode(HE_Timer_INIT_INTERRUPT_MODE);
}


/*******************************************************************************
* Function Name: HE_Timer_Enable
********************************************************************************
*
* Summary:
*  Enable the Timer
...
void HE_Timer_Enable(void) 
{
    ...
    #if (!HE_Timer_UDB_CONTROL_REG_REMOVED || HE_Timer_UsingFixedFunction)
        HE_Timer_CONTROL |= HE_Timer_CTRL_ENABLE;
...
*
* Global variables:
*  HE_Timer_initVar: Is modified when this function is called for the
*   first time. Is used to ensure that initialization happens only once.
*
*******************************************************************************/
void HE_Timer_Start(void) 
{
    if(HE_Timer_initVar == 0u)
    {
        HE_Timer_Init();

        HE_Timer_initVar = 1u;   /* Clear this bit for Initialization */
    }
...
void HE_Timer_Stop(void) 
{
    /* Disable Timer */
    #if(!HE_Timer_UDB_CONTROL_REG_REMOVED || HE_Timer_UsingFixedFunction)
        HE_Timer_CONTROL &= ((uint8)(~HE_Timer_CTRL_ENABLE));
    #endif /* Remove assignment if control register is removed */
...
/*******************************************************************************
* Function Name: HE_Timer_SetInterruptMode
********************************************************************************
*
* Summary:
...
{
    HE_Timer_STATUS_MASK = interruptMode;
}


/*******************************************************************************
* Function Name: HE_Timer_SoftwareCapture
********************************************************************************
*
* Summary:
...
void HE_Timer_SoftwareCapture(void) 
{
    ...
    #else
        (void)CY_GET_REG8(HE_Timer_COUNTER_LSB_PTR_8BIT);
...
/*******************************************************************************
* Function Name: HE_Timer_ReadStatusRegister
********************************************************************************
*
* Summary:
...
{
    return (HE_Timer_STATUS);
}


#if (!HE_Timer_UDB_CONTROL_REG_REMOVED) /* Remove API if control register is unused */


/*******************************************************************************
* Function Name: HE_Timer_ReadControlRegister
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: HE_Timer_WriteControlRegister
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: HE_Timer_ReadPeriod
********************************************************************************
*
* Summary:
...
{
   #if(HE_Timer_UsingFixedFunction)
       return ((uint16)CY_GET_REG16(HE_Timer_PERIOD_LSB_PTR));
   #else
       return (CY_GET_REG16(HE_Timer_PERIOD_LSB_PTR));
   #endif /* (HE_Timer_UsingFixedFunction) */
}


/*******************************************************************************
* Function Name: HE_Timer_WritePeriod
********************************************************************************
*
* Summary:
...
void HE_Timer_WritePeriod(uint16 period) 
{
    ...
    #else
        CY_SET_REG16(HE_Timer_PERIOD_LSB_PTR, period);
    #endif /*Write Period value with appropriate resolution suffix depending on UDB or fixed function implementation */
}


/*******************************************************************************
* Function Name: HE_Timer_ReadCapture
********************************************************************************
*
* Summary:
...
{
   #if(HE_Timer_UsingFixedFunction)
       return ((uint16)CY_GET_REG16(HE_Timer_CAPTURE_LSB_PTR));
   #else
       return (CY_GET_REG16(HE_Timer_CAPTURE_LSB_PTR));
   #endif /* (HE_Timer_UsingFixedFunction) */
}


/*******************************************************************************
* Function Name: HE_Timer_WriteCounter
********************************************************************************
*
* Summary:
...
void HE_Timer_WriteCounter(uint16 counter) 
{
    ...
    #else
        CY_SET_REG16(HE_Timer_COUNTER_LSB_PTR, counter);
    #endif /* Set Write Counter only for the UDB implementation (Write Counter not available in fixed function Timer */
}


/*******************************************************************************
* Function Name: HE_Timer_ReadCounter
********************************************************************************
*
* Summary:
...
#if(!HE_Timer_UsingFixedFunction) /* UDB Specific Functions */
...
/*******************************************************************************
* Function Name: HE_Timer_ClearFIFO
********************************************************************************
*
* Summary:
...
{
    while(0u != (HE_Timer_ReadStatusRegister() & HE_Timer_STATUS_FIFONEMP))
    {
        (void)HE_Timer_ReadCapture();
    }
}
