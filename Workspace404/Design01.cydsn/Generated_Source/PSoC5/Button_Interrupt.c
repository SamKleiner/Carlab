...
void Button_Interrupt_SetVector(cyisraddress address)
{
    ...
    ramVectorTable[CYINT_IRQ_BASE + (uint32)Button_Interrupt__INTC_NUMBER] = address;
}
...
cyisraddress Button_Interrupt_GetVector(void)
{
    ...
    return ramVectorTable[CYINT_IRQ_BASE + (uint32)Button_Interrupt__INTC_NUMBER];
}
...
{
    *Button_Interrupt_INTC_PRIOR = priority << 5;
}
...
uint8 Button_Interrupt_GetPriority(void)
{
    ...
    priority = *Button_Interrupt_INTC_PRIOR >> 5;
