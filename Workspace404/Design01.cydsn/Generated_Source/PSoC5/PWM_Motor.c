...
void PWM_Motor_WritePeriod(uint8 period) 
{
    ...
    *******************************************************************************/
                                       ...
                                       
    {
            ...
            #else
                CY_SET_REG8(PWM_Motor_COMPARE2_LSB_PTR, (compare + 1u));
            #endif /* (PWM_Motor_UsingFixedFunction) */
    ...
    *******************************************************************************/
    ...
    {
        #if(PWM_Motor_UsingFixedFunction)
            return ((uint8)CY_GET_REG16(PWM_Motor_COMPARE1_LSB_PTR));
        #else
            return (CY_GET_REG8(PWM_Motor_COMPARE1_LSB_PTR));
        #endif /* (PWM_Motor_UsingFixedFunction) */
    }
    ...
    *******************************************************************************/
    ...
    {
        return (CY_GET_REG8(PWM_Motor_COMPARE2_LSB_PTR));
    }
...
{
    #if(PWM_Motor_UsingFixedFunction)
        return ((uint8)CY_GET_REG16(PWM_Motor_PERIOD_LSB_PTR));
    #else
        return (CY_GET_REG8(PWM_Motor_PERIOD_LSB_PTR));
    #endif /* (PWM_Motor_UsingFixedFunction) */
}
